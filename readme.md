...
Cette application a été pensée pour être simple, belle et instantanée.
...
L'application utilise le texte intégral de la **Bible Louis Segond (Édition 1910)**.
C'est la traduction classique francophone, reconnue pour sa fidélité au texte original et sa qualité littéraire.

## 🚀 À propos de l'application

Initialement développée comme un site web moderne, **Verset du Jour** est une application hybride. Elle combine la flexibilité du web (HTML/CSS) avec la puissance d'une application native via **Capacitor**, offrant une expérience fluide et sans temps de chargement.
